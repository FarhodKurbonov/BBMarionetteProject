...
(function(root, factory) {
  ...
  (function(Backbone, _) {
    ...
    Backbone.ChildViewContainer = function(Backbone, _) {
      ...
      _.extend(Container.prototype, {
        ...
        // by `cid` and makes it searchable by the models
        // cid (and models itself). Optionally specify
        ...
        // Find a view by the models that was attached to
        // it. Uses the models's `cid` to find it.
        findByModel: function(model) {
          return this.findByModelCid(model.cid);
        },
        // Find a view by the `cid` of the models that was attached to
        // it. Uses the models's `cid` to find the view `cid` and
  ...
  // ---------------------------
  //
  // These methods are used to bind/unbind a backbone "entity" (collection/models)
  ...
  // with underscore.js templates, serializing the view's models or collection,
  ...
  Marionette.ItemView = Marionette.View.extend({
    ...
    // Serialize the models or collection for the view. If a models is
    // found, `.toJSON()` is called. If a collection is found, `.toJSON()`
    // is also called, but is used to populate an `items` array in the
    // resulting data. If both are found, defaults to the models.
  ...
  // and renders an individual child view for each models.
  Marionette.CollectionView = Marionette.View.extend({
    ...
    // get the child view by models it holds, and remove it
    ...
    // Build a `childView` for a models in the collection.
  ...
  Marionette.CompositeView = Marionette.CollectionView.extend({
    ...
    // Renders the models once, and the collection once. Calling
    // this again will tell the models's view to re-render itself
    ...
    _renderRoot: function() {
      ...
      // will not be available until after the models is rendered, but should be

Backbone.Picky = (function (Backbone, _) {
  ...
  // models to be selected within a collection. Selection of another
  // models within the collection causes the previous models to be
  // deselected.
  ...
  _.extend(Picky.SingleSelect.prototype, {
    ...
    // Select a models, deselecting any previously
    // selected models
    ...
    // Deselect a models, resulting in no models
    // being selected
  ...
  _.extend(Picky.MultiSelect.prototype, {
    ...
    // Select a specified models, make sure the
    // models knows it's selected, and hold on to
    // the selected models.
    select: function (model) {
    ...
    // Deselect a specified models, make sure the
    // models knows it has been deselected, and remove
    // the models from the selected list.
    deselect: function (model) {
      if (!this.selected[model.cid]) { return; }
  ...
  // Picky.Selectable
  // ----------------
  // A selectable mixin for Backbone.Model, allowing a models to be selected,
  ...
  _.extend(Picky.Selectable.prototype, {
    ...
    // Select this models, and tell our
    ...
    // Deselect this models, and tell our

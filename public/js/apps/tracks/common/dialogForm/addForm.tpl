  <div class="form-group has-success has-feedback">
    ...
    <div class="col-md-9">
<input type="text" id="artistName" class="form-control" value="<%=data.trackName%>" name="trackName" disabled="true"/>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input type="text" id="artistName" class="form-control" name="name"/>
  ...
  <div class="form-group">
    ...
    <div class="col-md-9">
      <input class="form-control" type="text" id="youTubeLink" name="youTubeLink"/>
